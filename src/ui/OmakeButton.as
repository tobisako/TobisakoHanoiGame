package ui 
{
	 ...
	 * @author tobisako
	 */
	public class OmakeButton extends CastButton 
	{
		[Embed(source = "../img/btn_omake.png")] private var Emb:Class;

		/**
		 * 新しい OmakeButton インスタンスを作成します。
		 */
		public function OmakeButton( initObject:Object = null ) 
		{
			// 親クラスを初期化します。
			super( initObject );
